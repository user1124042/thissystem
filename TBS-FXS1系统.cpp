...
// 等待：sleep();// this is a wonderful windows 19.2.2
#include <chrono>
#include <cstdio> // 别用bits/stdc++
#include <cstring>
#include <random>
...
void update()
{
	...
	puts("2024-8-4 Beta 某AL又又又又在系统中添加了“千万别点”");
	puts("2024-8-4 Beta 不保留zmzx");
}
void looking()
{
...
{
	char xxx;
	cout << "Warning!本系统对“千万要点”所造成的bug和对电脑的伤害概不负责，是否继续操作？（Y/Y/Y)";
	cin >> xxx;
	if(xxx == 'Y'){
		int absd;
		...
		scanf("%d", &absd);
		if(absd == 1){
			puts("乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋");
			puts("乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋");
			puts("乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋");
			puts("乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋");
			puts("乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋");
			...
			puts("乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋");
			puts("乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋");
			puts("乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋");				puts("乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋");
			puts("乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋");
			puts("乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋");
			puts("乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋");
			puts("乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋乐滋");
...
void pblktct()
{
	puts("alanbecker代码输出，sunyuhao负责编辑，AuroraRealm设计&程序员。此版权为Wisterl公司所有，请勿在未获得权限");
	puts("的情况下私自在各网站上发布，谢谢");
	puts("洛谷网站                        alanbecker联系洛谷alanbecker");
	puts("https://www.luogu.com                  sunyuhao联系洛谷stzhl");
...
void TBS()
{
	...
	puts("途中经历过3次改名");
	puts("第一次：windows 1(ubuntu)");
	puts("第二次：TBS-FXS");
	puts("第三次：Wisterl");
	puts("内由三名成员组成");
	puts("分别是：AuroraRealm：(总代码输出)");
...
>>>>>>> 1a83fb363cfb7438b94a60b3ff88eb7e67f7f50d
}
...
int main()
{
	...
	puts("默认：登入官方账号");
	scanf("%s\n%s", &qaz, &wsx);
	if ((strcmp(qaz, "Ed_Wis_gfzh") == 0 && strcmp(wsx, "gh5ter") == 0) || (strcmp(qaz, "Ed_Wis_gfzh") == 0 && strcmp(wsx, "\0") == 0))
	{
		// username
		...
		puts("*     *     *       *                   *       *       *             *       *     *                      *             *           * ");
		puts("************* ************* *************       *       ************* *          *  *************          ************* ************ ");
		puts("                           智     能     计     算     机     Wisterl ED    系		统								");
		puts("                                         Made with Wisterl ED (版权所有)");
		puts("");
		puts("*****        *********     *********");
		puts("*    ***     *       *     *        ");
		...
		printf("\033[1;37m");
		Prints("MADE IN CHINA,wisterl", 75);
		Prints("                       ", 100);
		Prints("Closeing·······", 300);
		this_thread::sleep_for(chrono::seconds(1));
		} else {
